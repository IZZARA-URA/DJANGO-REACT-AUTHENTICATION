...
// http://localhost:8000/api/my-messages/1
            ...
            <div className="row g-0">
              ...
              <div className="px-2 ">
                  <div className="d-flfex align-itemfs-center">
                    <div className="flex-grow-1 d-flex align-items-center mt-2">
                      <input
                        ...
                        name='username'
                      />
                      <button className='ml-1 btn' onClick={SearchUser} style={{border:"none"}}>
                ...
                {messages.map((message, index) =>
                  <Link to={"/inbox/" + (message.sender.id === user_id ? message.reciever.id : message.sender.id)} className="list-group-item list-group-item-action border-0"  key={index}>
                    <small>
                    ...
                    {message.sender.id !== user_id && <img src={message.sender_profile.image} className="rounded-circle mr-1" alt="1" width={40} height={40}/>}
                    {message.sender.id === user_id && <img src={message.reciever_profile.image} className="rounded-circle mr-1" alt="2" width={40} height={40}/>}
                      <div className="flex-grow-1 ml-3">
                          {message.sender.id === user_id && (message.reciever_profile.full_name !== null ? message.reciever_profile.full_name : message.reciever.username)}
